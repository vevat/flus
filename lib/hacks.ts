...
const _HACKS: Hack[] = [
  // ---- CUT ----
  {
    ...
    title: "Dropp snacken til 15 kr",
    blurb: "En brus, en nudelpakke, en sjokolade — 15 kr/dag høres lite ut, men gir enorme summer over tid.",
    amount: 15,
    frequency: "daily",
    category: "cut",
    effort: 1,
